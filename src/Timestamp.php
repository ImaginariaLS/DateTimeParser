 ...
 * @version $Id: Timestamp.php 3515 2011-12-28 12:29:24Z mdomba $
        ...
        for ($i = 0; $i < $max; $i++) {
            switch ($fmt[$i]) {
                ...
                case 'r': // Thu, 21 Dec 2000 16:01:07 +0200
                    ...
                    $dates
                        .= gmdate('D', $_day_power * (3 + self::getDayOfWeek($year, $month, $day))) . ', '
                    ...
                    $dates .= ($min < 10) ? ":0{$min}": ":{$min}";

                    // if ($secs < 10) $dates .= ':0' . $secs; else $dates .= ':' . $secs;
                    $dates .= ($secs < 10) ? ":0{$secs}" : ":{$secs}";
